...
Version  : 4.0.3
Release  : 4
URL      : https://cran.r-project.org/src/contrib/effects_4.0-3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/effects_4.0-3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1534716430
